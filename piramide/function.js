...
// contador i começa em ZERO, enquanto i < count [8] o i vai receber ele mesmo mais 1.
for (i = 0; i < count; i++) {
    // rows.push(padRow(i + 1, count)) -> a cada rodada, a função é inicializada, retornando para o rows um valor diferente.
    // padRow(i + 1, count) -> o padRow dentro do laço faz com que a function funcione de acordo com o resultado gerado, por exemplo, quando o i estiver em 4, a function vai ser padRow(4, 8).
